...
class LigaRepositoryImpl : LigaRepository {

    override fun getLiga() : MutableLiveData<List<Liga>> {
        ...
        list.add(
            Liga(
                ...
                "a10_english_league_1"
            )
        )

        val liveData : MutableLiveData<List<Liga>> = MutableLiveData()
    ...
    companion object{
        @Volatile private var instance: LigaRepositoryImpl? = null

        fun getInstance() = instance?: synchronized(this){

            instance?: LigaRepositoryImpl().also { instance = it }
        }
    }
}